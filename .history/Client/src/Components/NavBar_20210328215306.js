...
const NavBar = () => {
  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-white py-4 md:px-12 shadow-md border-solid border-t-2 border-blue-700">
      ...
      >
        <div className="flex items-center flex-shrink-0 text-blue-700 mr-10">
          <svg
      ...
      <div
        classNameName={`menu w-full md:block flex-grow md:flex md:items-center md:w-auto md:px-3 px-8 ${
          togglemenu ? "block" : "hidden"
        }`}
      >
        <div className="text-md font-bold text-blue-700 md:flex-grow  ">
          <a href="#responsive-header" className="btn-menu">
            Home
          </a>
        </div>
        {/* search */}
        ...
        <div className="flex justify-center items-center">
          <a href="#pablo" className="btn-action">
            Sign in
          </a>
          <a href="#pablo" className="btn-action ">
            login
