    ...
    <div class="block md:flex ">
      <div class="w-full md:w-1/2 md:mx-2 mb-4 shadow-lg">
        <div class="bg-white rounded-lg ">
          ...
          <div class="flex items-center border-t-2 border-blue-700 m-2 justify-between">
            <button class="bg-white text-gray-800 font-bold rounded border-b-2 border-green-500 hover:border-green-600  hover:text-white shadow-md py-2 px-6 inline-flex items-center">
