  ...
  const Likes = () => {
    ...
    if (post.likeCount.length > 0) {
      return post.likeCount.find(
        (like) => like === "606a2877355b004a70d3d84d" //(user?.result?.googleId || user?.result?._id)
      ) ? (
        <>
            ...
            <div className="flex items-center">
              <div>
                {creator?.avatar ? (
                  ...
                  <span className="w-12 h-12 flex items-center justify-center rounded-full text-white font-bold bg-yellow-600">
