        ...
        <div class="bg-white shadow-2xl rounded-lg tracking-wide">
          <div class="md:flex-shrink-0">
            <img
              ...
              alt="mountains"
              class="h-56 w-full object-cover object-center rounded-lg rounded-b-none"
            />
          </div>
      ...
      <div class="w-auto">
        <div class="bg-white shadow-2xl rounded-lg tracking-wide">
          ...
          <div class="px-4 py-2 mt-2">
            ...
            <div class="flex items-center justify-between mt-2 mx-6">
              <a href="#pable" class="text-blue-500 text-xs -ml-3 ">
                Show More
              </a>
              <a href="#pable" class="flex text-gray-700">
                <svg
                  fill="none"
                  viewBox="0 0 24 24"
                  class="w-6 h-6 text-blue-500"
            ...
            <div class="author flex items-center -ml-3 my-3">
              ...
              <h2 class="text-sm tracking-tighter text-gray-900">
                <a href="#pable">By Mohammed Ibrahim</a>{" "}
                <span class="text-gray-600">21 SEP 2015.</span>
              </h2>
            </div>
          </div>
