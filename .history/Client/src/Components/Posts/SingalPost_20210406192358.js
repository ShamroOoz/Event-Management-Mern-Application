      ...
      <div className=" md:mx-2 mb-4 shadow-lg">
        <div className="bg-white rounded-lg ">
          ...
          <div className="p-4 pb-3 max-h-screen">
            <span className="block text-blue-700 font-semibold uppercase mb-2 text-2xl md:text-base lg:text-lg">
              {post?.title}
            </span>
            <div className="text-gray-600 h-10 uppercase text-sm leading-relaxed block md:text-xs lg:text-sm">
              {post?.message}
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm tracking-tighter uppercase text-black">
                  {creator?.name}
                </p>
