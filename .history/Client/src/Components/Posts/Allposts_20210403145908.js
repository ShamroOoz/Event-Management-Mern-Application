...
const Allposts = () => {
  ...
  const DeleteListner = () => {
    console.log("DeleteListner Listner");
  };
  if (state.loading) return <Spinner />;
  return (
    <div className="flex flex-wrap ">
      {state.postData.map((post) => (
        <div key={post._id} className="w-full md:w-1/2">
            ...
            <div className="bg-white rounded-lg ">
              ...
              <div className="p-4 pb-3 max-h-screen">
                ...
                <div className="text-gray-600 text-sm leading-relaxed block md:text-xs lg:text-sm">
                  ...
                  quidem blanditiis unde asperiores? Officia amet perspiciatis
                  ad quibusdam incidunt eaque, nobis, eveniet neque porro id
                  commodi quisquam debitis!
                </div>
              ...
              <div className="flex items-center border-t-2 border-blue-700 m-2 justify-between">
                ...
                <button className="btn-post" onClick={DeleteListner}>
                  <span className="mr-2">
