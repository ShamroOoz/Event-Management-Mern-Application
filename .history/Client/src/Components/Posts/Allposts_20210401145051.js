      ...
      <div class="w-full md:w-1/2 md:mx-2 mb-4 md:mb-0">
        <div class="bg-white rounded-lg shadow ">
          ...
          <div class="p-4 h-auto md:h-40 lg:h-48">
            <a
              href="#pable"
              class="block text-blue-500 hover:text-blue-600 font-semibold mb-2 text-lg  lg:text-lg"
            >
              Woman standing under blue sky
            </a>
            <div class="text-gray-600 text-sm leading-relaxed block ">
            ...
            <div class="mb-4 ">
              <span class=" bg-gray-300 py-1 px-2 rounded-full text-xs lowercase text-gray-700">
                #something
              </span>
            </div>
          </div>
