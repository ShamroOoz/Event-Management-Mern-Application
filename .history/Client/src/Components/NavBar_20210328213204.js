...
const NavBar = () => {
  ...
  return (
    <nav class="flex items-center justify-between flex-wrap bg-white py-4 md:px-12 shadow-md border-solid border-t-2 border-blue-700">
      <div class="flex justify-between md:w-auto w-full md:border-b-0 border-solid border-b-2 border-gray-300 pl-6 pr-2 pb-5 md:pb-0">
        <div class="flex items-center flex-shrink-0 text-blue-700 mr-10">
          <span class="font-semibold text-xl tracking-tight">Memmories</span>
        </div>
        {/* toggle menu button */}
