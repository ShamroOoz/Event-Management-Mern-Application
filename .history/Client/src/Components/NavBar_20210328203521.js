      ...
      <div class="menu w-full md:block flex-grow md:flex md:items-center md:w-auto md:px-3 px-8">
        <div class="text-md font-bold text-blue-700 md:flex-grow">
          <a
            ...
            class="block mt-4 md:inline-block md:mt-0 hover:text-white px-4 py-2 rounded hover:bg-blue-700 mr-2"
          >
            Menu 1
          </a>
        </div>
        ...
        <div class="relative mx-auto text-gray-600 md:block hidden">
          <input
            class="btn-search focus:outline-none focus:ring focus:border-blue-300"
            type="search"
            name="search"
            placeholder="Search"
          />
